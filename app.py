...
# ==========================================
st.set_page_config(
    page_title="CardioPredict Clinical Command Center",
    page_icon="🫀",
    layout="wide",
    initial_sidebar_state="expanded"
)

# Custom CSS Injector for Enterprise Design Language
st.markdown("""
    <style>
    ...
    /* Custom Diagnostic Cards */
    .metric-card {
        background-color: #ffffff;
        padding: 20px;
        border-radius: 12px;
        box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05), 0 2px概念4px -1px rgba(0,0,0,0.03);
